...
<head>
  <meta charset="UTF-8">
  <title>Invoice || Khasan Labels Indonesia</title>
...
<body>
  ...
  <form method="post">
    <input type="hidden" name="formids" id="formids" value="{{$formid}}">
    <input type="hidden" name="country" id="country" value="{{$country}}">
<div class="row expanded">
  <main class="columns">
    <div class="inner-container">
    <header class="row align-center">
{{-- <button class="button" type="submit" formaction="{{ url('pdfview') }}"><i class="ion ion-ios-printer-outline"></i>Print Invoice</button> --}}
        <a href="{!! url('/')!!}" class="button hollow secondary"><i class="ion ion-chevron-left"></i> Go Back to Purchases</a>

        &nbsp;&nbsp;<a  type="button" onclick="window.print();" class="button"><i class="ion ion-ios-printer-outline"></i> Print Invoice</a>
      </header>
    <section class="row">
